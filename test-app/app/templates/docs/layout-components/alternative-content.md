...
To create your own alternative content component, you can either create a component in your app with the path `ember-skeleton/alternative-content`, or specify a custom path in the `alternativeContentComponent` property in your <LinkTo class="docs-md\_\_a" @route="docs.default-options">app wide default options</LinkTo>.
